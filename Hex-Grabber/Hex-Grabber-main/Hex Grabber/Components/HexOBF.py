...
'''.strip().encode()
    ...
    def encrypt2(self):
        ...
        self.code = f'''# Obfuscated using HexOBF
...
'''.strip().encode()
    ...
    def encrypt3(self):
        ...
        self.code = f'# Obfuscated using HexOBF base64, lzma; exec(compile(lzma.decompress(base64.b64decode({data})), "<string>", "exec"))'.encode()
